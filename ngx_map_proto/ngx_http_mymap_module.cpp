...
static ngx_int_t ngx_http_mymap_handler(ngx_http_request_t *r) {
    ...
    fflush(fout);
    for (ngx_uint_t i = 0; i < mapcell_num; ++i) {
    ...
    //remember to use set
    ngx_map__set_width(map, 4);
    ngx_map__set_height(map, 5);
